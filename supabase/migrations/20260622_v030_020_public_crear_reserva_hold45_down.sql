-- DOWN v030_020 — restaura public_crear_reserva con el hold de 30 min (body de v030_018).
-- CREATE OR REPLACE byte-identico salvo la constante v_hold_minutes (45 -> 30).
begin;
