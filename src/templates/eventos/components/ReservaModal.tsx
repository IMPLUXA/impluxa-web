...
export function ReservaModal({
  ...
  useEffect(() => {
    ...
    // Lock del scroll del fondo mientras el modal está abierto (sin scroll de la página detrás).
  ...
  return (
    <>
      ...
      {open &&
        createPortal(
          // Overlay renderizado en document.body (portal) -> escapa cualquier ancestro con
          // transform/filter que atrape un position:fixed (la causa del modal "embebido/chico").
          // El sizing/centrado/responsive vive en las clases .rm-overlay / .rm-modal (ver <style>).
          <div
          ...
          >
            <div className="rm-modal" onClick={(e) => e.stopPropagation()}>
              ...
              >
                Cuando quedan pocos lugares te mostramos cuántos. Con cupo
                amplio, solo “Con salidas”.
              </div>
      ...
      <style>{`
        ...
        /* DESKTOP: overlay oscuro full-viewport + modal grande centrado con aire + scroll interno */
        ...
        /* MOBILE: full-screen (100vw x 100dvh), sin bordes/radio, scroll interno */
