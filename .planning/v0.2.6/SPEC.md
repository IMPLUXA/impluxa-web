...
## 4. Open questions (CAPTURED, NOT ASSUMED)
...
| Backend Architect (Agent tool real)  | OQ-1, OQ-4, OQ-7 technical decisions                            | ⏳ To convene next session          |
| Security Engineer (Agent tool real)  | OQ-5, OQ-9 risk decisions; final burn migration sign-off        | ⏳ To convene next session          |
